...
c1_3_5 = c1_3.children.create(name: "轉向確認", options1: "正常|異常")
c1_3_6 = c1_3.children.create(name: "排風機座螺絲是否鎖緊", options: "是|否")

c1_4_1 = c1_4.children.create(name: "噴氣時間(0.2S)", options1: "正常|異常")
c1_4_2 = c1_4.children.create(name: "噴氣間隔時間", unit: "Sec")
c1_4_3 = c1_4.children.create(name: "噴氣壓力(5 kg/c㎡)", options1: "正常|異常")
c1_4_4 = c1_4.children.create(name: "集塵檢查結果", options1: "正常|異常")
...
c2_3_5 = c2_3.children.create(name: "轉向確認", options1: "正常|異常")
c2_3_6 = c2_3.children.create(name: "排風機座螺絲是否鎖緊", options: "是|否")

c2_4_1 = c2_4.children.create(name: "噴氣時間(0.2S)", options1: "正常|異常")
c2_4_2 = c2_4.children.create(name: "噴氣間隔時間", unit: "Sec")
c2_4_3 = c2_4.children.create(name: "噴氣壓力(5 kg/c㎡)", options1: "正常|異常")
c2_4_4 = c2_4.children.create(name: "集塵檢查結果", options1: "正常|異常")
...
c3_5_1 = c3_5.children.create(name: "檢查填充層高度正常", options1: "正常|異常")
c3_5_2 = c3_5.children.create(name: "檢查填充層是否清洗", options: "是|否")

c3_6_1 = c3_6.children.create(name: "檢查除霧層高度正常", options1: "正常|異常")
c3_6_2 = c3_6.children.create(name: "檢查除霧層是否清洗", options: "是|否")

c3_7_1 = c3_7.children.create(name: "檢查皮帶張力是否正常", options1: "正常|異常")
c3_7_2 = c3_7.children.create(name: "檢查軸承是否無異常聲音、生熱", options: "是|否")
c3_7_3 = c3_7.children.create(name: "檢查外殼&葉輪是否正常", options1: "正常|異常")
...
c4_1_7 = c4_1.children.create(name: "檢查皮帶鬆緊度是否正常", options1: "正常|異常")
...
d1_1_1 = d1_1.children.create(name: "內外表面無顯著損傷、裂痕、變形及腐蝕", options1: "正常|異常")
d1_1_2 = d1_1.children.create(name: "蓋、凸緣、閥、旋塞等無異常", options1: "正常|異常")
d1_1_3 = d1_1.children.create(name: "安全閥、壓力錶與其他安全裝置之性能正常", options1: "正常|異常")
d1_1_4 = d1_1.children.create(name: "啟動前已將凝結水排除乾淨", options1: "正常|異常")
d1_1_5 = d1_1.children.create(name: "空氣壓縮機達到設定壓力時會自動停止運轉", options1: "正常|異常")
d1_1_6 = d1_1.children.create(name: "空氣壓縮機無異常振動或異常聲音", options1: "正常|異常")
d1_1_7 = d1_1.children.create(name: "空氣壓縮機潤滑油液位正常", options1: "正常|異常")
d1_1_8 = d1_1.children.create(name: "氣壓保持在最高容許壓力之下", options1: "正常|異常")
d1_1_9 = d1_1.children.create(name: "空氣壓縮機及空氣儲存槽無異常發熱", options1: "正常|異常")
d1_1_10 = d1_1.children.create(name: "空氣儲存槽及管路接頭無漏氣現象", options1: "正常|異常")
d1_1_11 = d1_1.children.create(name: "壓縮空氣儲存槽及管件無銹蝕現象", options1: "正常|異常")
d1_1_12 = d1_1.children.create(name: "氣壓錶壓力指示正常", options1: "正常|異常")
d1_1_13 = d1_1.children.create(name: "自動控制裝置正常", options1: "正常|異常")
d1_1_14 = d1_1.children.create(name: "皮帶無過於鬆動", options1: "正常|異常")
d1_1_15 = d1_1.children.create(name: "電器開關動作或電器接線無異常", options1: "正常|異常")



u2.inspections.create(category_id: 47, value: "0.0")
u2.inspections.create(category_id: 48, value: "0.0")
u2.inspections.create(category_id: 49, value: "0.0")
u2.inspections.create(category_id: 50, value: "1.0")
u2.inspections.create(category_id: 51, value: "0.0")
u2.inspections.create(category_id: 52, value: "30.2")
u2.inspections.create(category_id: 53, value: "0.0")
u2.inspections.create(category_id: 54, value: "0.0")
u2.inspections.create(category_id: 55, value: "0.0")
u2.inspections.create(category_id: 56, value: "0.0")
u2.inspections.create(category_id: 57, value: "10.1")
u2.inspections.create(category_id: 58, value: "0.0")
u2.inspections.create(category_id: 59, value: "0.0")
u2.inspections.create(category_id: 60, value: "0.0")
u2.inspections.create(category_id: 61, value: "0.0")
u2.inspections.create(category_id: 62, value: "0.0")
u2.inspections.create(category_id: 63, value: "0.0")
u2.inspections.create(category_id: 64, value: "20.5")
u2.inspections.create(category_id: 65, value: "0.0")
u2.inspections.create(category_id: 66, value: "0.0")
u2.inspections.create(category_id: 67, value: "0.0")
u2.inspections.create(category_id: 68, value: "0.0")
u2.inspections.create(category_id: 69, value: "0.0")
u2.inspections.create(category_id: 70, value: "0.34")
u2.inspections.create(category_id: 71, value: "219.8")
u2.inspections.create(category_id: 72, value: "234.3")
u2.inspections.create(category_id: 73, value: "110.3")
u2.inspections.create(category_id: 74, value: "57.3")
u2.inspections.create(category_id: 75, value: "30.0")
u2.inspections.create(category_id: 76, value: "20.0")
u2.inspections.create(category_id: 77, value: "30.0")
u2.inspections.create(category_id: 78, value: "0.0")
u2.inspections.create(category_id: 79, value: "0.0")
u2.inspections.create(category_id: 80, value: "0.0")
u2.inspections.create(category_id: 81, value: "0.0")
u2.inspections.create(category_id: 82, value: "10.0")
u2.inspections.create(category_id: 83, value: "10.0")
u2.inspections.create(category_id: 84, value: "0.0")
u2.inspections.create(category_id: 85, value: "0.0")
u2.inspections.create(category_id: 86, value: "0.0")
u2.inspections.create(category_id: 87, value: "0.0")
u2.inspections.create(category_id: 88, value: "1.0")
